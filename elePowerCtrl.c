...
int main()
{
    ...
    while (1)
    {
        ...
        {
            printf("\nSuccess: Receive message from powerSupply\n");
            ...
            {
                printf("Success: Receive system infor from powerSupplyInfoAccess\n");
            ...
            printf("Pending: Taking device information...\n");
            ...
            if (msgrcv(msgId4, &message4, sizeof(message4), 1, 0) != -1)
            {
                printf("Success: Receive  powerSupplyInfoAccess..\n");
                memset(infoBuffer, 0, sizeof(infoBuffer));
                strcpy(infoBuffer, message4.mesg_text);
            ...
            if (strcmp(requestedMode, equipInfo.status) == 0)
            {
                ...
                printf("Success: Sended message to powerSupply...\n");
            }
            ...
            else
            {
                ...
                else // nếu cần cung cấp > hạn mức
                {
                    ...
                    msgsnd(msgId2, &message2, sizeof(message2.mesg_text), 0);
                    printf("Success: Sended message to powerSupplyInfoAccess\n");

                    // nhận message từ powerSupplyInfoAccess
                    if (msgrcv(msgId4, &message4, sizeof(message4), 1, 0) != -1)
                    {
                        printf("Success: Received message from powerSupplyInfoAccess\n");
                        memset(infoBuffer, 0, sizeof(infoBuffer));
                        strcpy(infoBuffer, message4.mesg_text);
